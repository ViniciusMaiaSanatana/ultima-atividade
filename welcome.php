...
<div class="row d-flex justify-content-center">
<div class="col md-4 d-flex justify-content-center">
<a class="btn btn-dark" href="cadastrar_vendedor.php" role="button">Cadastrar Vendedor</a>
</div>
<div class="col md-4 d-flex justify-content-center">
<a class="btn btn-dark" href="consultar_vendedor.php" role="button">Consultar Vendedor</a>
<div class="col md-4 d-flex justify-content-center">
<a class="btn btn-dark" href="listar_vendedor.php" role="button">Listar Vendedor</a>
</div>
<div class="col md-4 d-flex justify-content-center">
<a class="btn btn-dark" href="excluir_vendedor.php" role="button">Excluir Vendedor</a>
</div></div>
