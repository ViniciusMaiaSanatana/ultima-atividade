...
<div class="container">
<h1>EXCLUIR CADASTRO DE VEICULOS</h1>
<form method="post">
<div class="mb-3">
<br>
<label class="form-label">ID do veiculo</label>
<input type="number" name="id" class="form-control" placeholder="Digite o ID do veiculo que queira buscar">
...
echo "<input type='submit' class='btn btn-primary' name='botaoapagar' value='apagar cadastro do veiculo'>";
...
function btapagar(){
    ...
    if($conexao->query($sql) == TRUE){
        ...
        echo "<h1>ERRO, apago não menor<h1>";
    }
mysqli_close($conexao);
